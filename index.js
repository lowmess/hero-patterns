...
export function set (el, pattern, fill = 000000, opacity = 0.8) {
  el.style.backgroundImage = pattern
  el.style.backgroundPosition = 'center'
}

export function setRandom (el, fill = 000000, opacity = 0.8) {
...
export function marble (el, time = 250, fill = 000000, opacity = 0.8) {
...
export function flash (el, time = 250, fill = 000000, opacity = 0.8) {
  setRandom(el, fill, opacity)
